        ...
        <nav class="navbar navbar-default navbar-fixed-top nav-transparent overlay-nav sticky-nav nav-white nav-border-bottom no-transition" role="navigation">
            <div class="container">
                <div class="row">
                    ...
                    <!--<li class="dropdown panel">
                                    <a  href="#collapse2" class="dropdown-toggle collapsed" data-toggle="collapse" data-parent="#accordion" data-hover="dropdown">{{ Auth::user()->currentTeam->name }} <i class="fa fa-angle-down"></i></a>-->
                                    <!-- sub menu -->
                        <!--<ul id="collapse2" class="dropdown-menu ">
                            <li class="mega-menu-column col-sm-6">
                                <ul>
                                ...
                                <!-- menu item -->
                        <li class="dropdown panel">
                                     <a href="#collapse6" class="dropdown-toggle " data-toggle="collapse" data-parent="#accordion" data-hover="dropdown"> {{ strtoupper(app()->getLocale()) }} <i class="fa fa-angle-down"></i></a>

                            <ul id="collapse6" class="dropdown-menu ">
